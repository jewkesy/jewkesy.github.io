...
function initialiseGameBoards(msg) {
	...
	loadGrid('playerFleet', playerFleet, "Player Fleet", "animate__animated animate__zoomInUp", msg.gameObj.playerGrid, msg.gameObj.progress.computerProgress);
}
...
function loadGrid(id, src, altTxt, cssClass, gameGrid, progress) {
	console.log(gameGrid, progress)
	var eleGrid = document.getElementById(id);
	eleGrid.innerHTML = buildGrid(gameGrid, progress)
...
var sunkship = "data:image/png;base64,";
	...
	for (var i = 0; i < grid.length; i++) {
		...
		for (var j = 0; j < grid[0].length; j++) {
			...
			else if (grid[i][j] == 1) retVal += '<img width="29px" src="'+greenship+'" alt="ship" />'; //ship untouched
			else if (grid[i][j] == 2) retVal += '<img width="29px" src="'+splash+'" alt="splash" />'; //miss
			else if (grid[i][j] == 3) retVal += '<img width="29px" src="'+flame+'" alt="flame" />'; //hit
			else if (grid[i][j] == 4) retVal += '<img width="29px" src="'+sunkship+'" alt="sunk" />'; //sunk
	...
	retVal += "<tr><td style='border:none !important; height:10px;' colspan='" + grid[0].length+1 + "'><div class='stacked-bar-graph'><span style='width: "+progress+"%; background:green;'>"+progress+"%</span><span style='width: "+total+"%;'></span></div></td></tr>";
